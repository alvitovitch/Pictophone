        ...
        return (
            <div id='splashMain'>
                <div className="splash-tutorial">
                    <img src="/images/pointing-hand.webp" alt="tutorial 1" />
                    <div>
                        <h1>WHAT IS PICTOPHONE?</h1>
                        <h2>It seems so long ago that we could gather in person and play games, but things have changed. Enter Pictophone! Pictophone is a multiplayer game that allows users to meet up online, chat, and draw together.</h2>
                    </div>
                </div>
                <div className="splash-tutorial">
                    <div>
                ...
                <div className="splash-tutorial">
                    <img src="/images/pointing-hand.webp" alt="tutorial image 3" />
                    <div>
                        <h1>WHERE TO NEXT?</h1>
                ...
                <div className="splash-tutorial">
                    ...
                    <img src="/images/pointing-hand.webp" alt="tutorial 3" />
